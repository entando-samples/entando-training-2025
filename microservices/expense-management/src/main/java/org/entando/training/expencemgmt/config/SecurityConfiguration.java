package org.entando.training.expencemgmt.config;

import org.entando.training.expencemgmt.config.jwt.JwtAuthConverter;
...
public class SecurityConfiguration {
    ...
    public static final String EXPENSE_BUNDLE_API = "/api/**";
